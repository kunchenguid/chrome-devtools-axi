...
The no-mistakes agent skill is supplied from the user's skill installation, not vendored in this repository; `.agents/skills/` exists only as the repository-local `.claude/skills` symlink target.
